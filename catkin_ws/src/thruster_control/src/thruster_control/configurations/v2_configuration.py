...
class V2Configuration:
    def __init__(self):
        ...
        self.a2 = math.pi / 2.0
        self.a4 = math.pi / 4.0
        self.a60 = math.pi / 3.0

        self.anew = math.pi / 2.5

    def get_thrusts_to_wrench(self):
        th_0 = gh.get_thruster_wrench_vector(x=self.dX,   y=self.dY,   z=self.dZ,   roll=0,  pitch=self.a60,  yaw=self.a2)
        th_1 = gh.get_thruster_wrench_vector(x=self.dX,   y=-self.dY,  z=self.dZ,   roll=0,  pitch=self.a60,  yaw=-self.a2)
        ...
        th_4 = gh.get_thruster_wrench_vector(x=-self.dX,  y=self.dY,   z=-self.dZ,  roll=0,  pitch=-self.a60,  yaw=self.a2)
        th_5 = gh.get_thruster_wrench_vector(x=-self.dX,  y=-self.dY,  z=-self.dZ,  roll=0,  pitch=-self.a60,  yaw=-self.a2)
