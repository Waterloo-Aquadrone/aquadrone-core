...
def get_thrusts_to_wrench():
    ...
    th_0 = gh.get_thruster_wrench_vector(x=dX,   y=dY,   z=0,  roll=0,  pitch=a4,  yaw=a2)
    th_1 = gh.get_thruster_wrench_vector(x=dX,   y=-dY,  z=0,  roll=0,  pitch=a4,  yaw=-a2)
    ...
    th_4 = gh.get_thruster_wrench_vector(x=-dX,  y=dY,   z=0,  roll=0,  pitch=a4,  yaw=a2)
    th_5 = gh.get_thruster_wrench_vector(x=-dX,  y=-dY,  z=0,  roll=0,  pitch=a4,  yaw=-a2)
